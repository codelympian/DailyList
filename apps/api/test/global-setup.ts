...
export default async function globalSetup(): Promise<void> {
  ...
  try {
    await prisma.$executeRawUnsafe(
      'TRUNCATE TABLE payments, transaction_items, transactions, products, customer_events, customer_identities, customers, sessions, business_memberships, businesses, users CASCADE',
    );
  } finally {
